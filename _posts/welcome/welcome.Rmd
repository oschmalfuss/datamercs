...
Thus, this site aims to showcase several tools and workflows, so that even the smallest publisher, or the interested librarian, can build upon that and implement their own (half-) automated data pipelines, from ERP to .MRC;-)  
